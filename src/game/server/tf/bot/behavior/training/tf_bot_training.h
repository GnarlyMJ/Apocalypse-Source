...
class CTFDespawn : public Action< HeatseakerBot >
{
public:
...
class CTFTrainingAttackSentryActionPoint : public Action< HeatseakerBot >
{
public:
	virtual ActionResult< HeatseakerBot >	Update( HeatseakerBot *me, float interval );
	virtual const char *GetName( void ) const	{ return "Despawn"; };
...
class CTFGotoActionPoint : public Action< HeatseakerBot >
{
public:
